<?php
    session_start();
    $_SESSION['source_url'] = 'artist_painting.php?ID='.$_GET['ID'];
?>
<!DOCTYPE html>
<html lang="en">
    <head>
        <title>Artist Painting</title>
        <meta charset="UTF-8">
            ...
            <div class="container-fluid">
                <?php
                    if(isset($_GET['ID']))
                    {
                        ...
                        $result1 = mysqli_query($db,"select * from artist where $ID = artist_id");
                        if($row = mysqli_fetch_assoc($result1)) {
                ?>      
                        <div class="container-lg my-5">
                            <h1 class="h3 text-secondary"><?php echo $row['a_first_name']." ".$row['a_last_name']; ?></h1>
                            <div class="mt-5">
                                <a href=" <?php echo $row['a_image']; ?>" data-lightbox = "mygallery">
                                <img src = " <?php echo $row['a_image']; ?>" class="img-fluid"></a>
                            </div>
                            <p class="lead my-5"><?php echo $row['a_description']; ?></p>
                        </div>
                ...
                <?php
                        ...
                        $result1 = mysqli_query($db,"select * from painting where $ID = a_id");
