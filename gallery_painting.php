<?php
    session_start();
    $_SESSION['source_url'] = 'gallery_painting.php?ID='.$_GET['ID'];
?>
<!DOCTYPE html>
<html lang="en">
    <head>
            ...
            <div class="container-fluid">
                <?php
                    if(isset($_GET['ID']))
                    {
                        ...
                        $result1 = mysqli_query($db,"select * from gallery where $ID = gallery_id");
                        if($row = mysqli_fetch_assoc($result1)) {
                ?>      
                        <div class="container-lg">
                            <h1 class="h2 text-secondary mt-5"><?php echo $row['g_name']; ?></h1>
                            <div class="mt-5">
                                <a href=" <?php echo $row['g_image']; ?>" data-lightbox = "mygallery">
                                <img src = " <?php echo $row['g_image']; ?>" class="img-fluid"></a>
                            </div>
                            <p class="lead mt-5"><?php echo $row['g_description']; ?></p>
                            <p class="lead mb-5"><?php echo $row['g_address']; ?></p>
                        </div>
                ...
                <?php
                        ...
                        $result1 = mysqli_query($db,"select * from painting where $ID = glr_id");
