<?php
    session_start();
    $_SESSION['source_url'] = 'archive_exhibition.php';
?>
<!DOCTYPE html>
<html lang="en">
    <head>
        <title>Archived Exhibition</title>
        <meta charset="UTF-8">
    ...
    <body>
        ...
        <section class="main">
            ...
            <?php
                ...
                $result = mysqli_query($db,"select * from exhibition where e_date < cast(current_timestamp as date) order by e_date DESC");
